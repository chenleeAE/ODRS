<?php
    ...
    try {
        ...
        // Email subject and body for notifying that the documents have been claimed
        $subject = 'Your Documents Have Been Successfully Claimed';
        $body = '
        <html>
            <head>
                <style>
            ...
            <body>
                <div class="container">
                    <div class="content">
                        <p>Dear Client,</p>
                        <p>We are pleased to inform you that your document request has been successfully claimed.</p>
        ...
        if (sendEmail($email, $subject, $body)) {
            ...
            $query = "UPDATE `request_type` SET `status` = 'CLAIMED' WHERE id = ?";
