$(document).on('click', '[name="btnAdvice"]', function() {
    ...
    $.get('../modules/marriage_license/save-bride-advice-auto.php', { license_id },  (response) => {
...
function fetchAdvice() {
    ...
    var license_id = $("input[name='license_id']").val();
    const url = '../modules/marriage_license/get-bride-advice.php';
...
$('#advice-form').submit(function(e) {
    ...
    $.ajax({
        url: '../modules/marriage_license/save-bride-advice.php',
        type: 'POST',
        data: formData,
