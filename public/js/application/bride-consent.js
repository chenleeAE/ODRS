$(document).on('click', '[name="btnConsent"]', function() {
    ...
    $.get('../modules/marriage_license/save-bride-consent-auto.php', { license_id },  (response) => {
...
function fetchConsents() {
    ...
    var license_id = $("input[name='license_id']").val();
    const url = '../modules/marriage_license/get-bride-consent.php';
...
$('#consent-form').submit(function(e) {
    ...
    $.ajax({
        url: '../modules/marriage_license/save-bride-consent.php',
        type: 'POST',
        data: formData,
