<div class="modal fade" id="marriage-modal" tabindex="-1" role="dialog" data-keyboard="false" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" id="close-marriage"><span>&times;</span></button>
                <h4 class="modal-title"><i class="fa fa-plus-square"></i> Apply Marriage Certificate</h4>
            </div>
            <form id="marriage-form" class="form-horizontal" autocomplete="off">
                <div class="modal-body">
                    <div class="panel">
                        <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="i-checks checkbox-inline">
                                            <label><input type="radio" value="MARRIAGE CERTIFICATE" name="request_for" required> MARRIAGE CERTIFICATE</label>
                                        </div>
                                        <div class="i-checks checkbox-inline">
                            ...
                            <div class="form-group">
                                <p class="font-bold">NAME OF HUSBAND</p>
                                <div class="row">
                                    <div class="col-md-4">
                                        <label>First Name<span class="text-danger">*</span></label> 
                                        <input type="text" name="husband_fname" class="form-control" placeholder="Enter data here" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Middle Name</label> 
                                        <input type="text" name="husband_mname" class="form-control" placeholder="Enter data here">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Last Name<span class="text-danger">*</span></label> 
                                        <input type="text" name="husband_lname" class="form-control" placeholder="Enter data here" required>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group">
                                <p class="font-bold">MAIDEN NAME OF WIFE</p>
                                <div class="row">
                                    <div class="col-md-4">
                                        <label>First Name<span class="text-danger">*</span></label> 
                                        <input type="text" name="wife_fname" class="form-control" placeholder="Enter data here" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Middle Name</label> 
                                        <input type="text" name="wife_mname" class="form-control" placeholder="Enter data here">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Last Name<span class="text-danger">*</span></label> 
                                        <input type="text" name="wife_lname" class="form-control" placeholder="Enter data here" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select id="marriage_province" name="pob_province" class="form-control" required>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select id="marriage_city" name="pob_city" class="form-control" required>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Country</label>
