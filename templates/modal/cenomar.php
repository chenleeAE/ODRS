<div class="modal fade" id="cenomar-modal" tabindex="-1" role="dialog" data-keyboard="false" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" id="close-cenomar"><span>&times;</span></button>
                <h4 class="modal-title"><i class="fa fa-plus-square"></i> Apply CENOMAR</h4>
            </div>
            <form id="cenomar-form" class="form-horizontal" autocomplete="off">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select id="cenomar_province" name="pob_province" class="form-control" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="cenomar_city" name="pob_city" class="form-control" required>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Country</label>
