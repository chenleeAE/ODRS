<div class="modal fade" id="birth-modal" tabindex="-1" role="dialog" data-keyboard="false" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" id="close-birth"><span>&times;</span></button>
                <h4 class="modal-title"><i class="fa fa-plus-square"></i> Apply Birth Certificate</h4>
            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="i-checks checkbox-inline">
                                    <label><input type="radio" value="BIRTH CERTIFICATE" name="request_for" required> BIRTH CERTIFICATE</label>
                                </div>
                                <div class="i-checks checkbox-inline">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select id="birth_province" name="pob_province" class="form-control" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="birth_city" name="pob_city" class="form-control" required>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Country</label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="father_fname" class="form-control" placeholder="Enter data here">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Father's Middle Name</label> 
                                        <input type="text" name="father_mname" class="form-control" placeholder="Enter data here">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Father's Last Name</label> 
                                        <input type="text" name="father_lname" class="form-control" placeholder="Enter data here">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="mother_fname" class="form-control" placeholder="Enter data here">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Mother's Middle Name</label> 
                                        <input type="text" name="mother_mname" class="form-control" placeholder="Enter data here">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Mother's Last Name</label> 
                                        <input type="text" name="mother_lname" class="form-control" placeholder="Enter data here">
                                    </div>
                                </div>
                            </div>
